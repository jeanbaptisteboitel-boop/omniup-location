...
export const includeAppel = {
  bail: { include: { lot: { include: { bailleur: true } }, locataire: true } },
...
export const includeCourrier = { bail: { include: { lot: { include: { bailleur: true } }, locataire: true } } } satisfies Prisma.CourrierInclude;
