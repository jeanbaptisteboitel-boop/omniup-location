...
export const VARIABLES_MODELE: { cle: string; description: string }[] = [
  ...
  { cle: "locataire.nomComplet", description: "Civilité, prénom et nom du locataire" },
  { cle: "locataire.dateNaissance", description: "Date de naissance du locataire" },
  { cle: "locataire.adresse", description: "Adresse actuelle du locataire" },
  { cle: "locataire.email", description: "Email du locataire" },
  { cle: "locataire.telephone", description: "Téléphone du locataire" },
