...
export const VARIABLES_MODELE: { cle: string; description: string }[] = [
  ...
  { cle: "bail.tauxTva", description: "Taux de TVA du bail (« 20 % »), vide si exonéré" },
  { cle: "bail.tvaMensuelle", description: "TVA mensuelle sur le loyer et les charges, vide si exonéré" },
  { cle: "bail.totalMensuelTTC", description: "Total mensuel charges comprises, TVA comprise" },
  { cle: "bail.regimeTva", description: "Régime de TVA du bail (soumis au taux de…, exonéré…)" },
  { cle: "bailleur.numeroTva", description: "Numéro de TVA intracommunautaire du bailleur" },
